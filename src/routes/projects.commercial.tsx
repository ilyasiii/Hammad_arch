...
export const Route = createFileRoute("/projects/commercial")({
  head: () => ({
    meta: [
      { title: "Commercial Ph. G studio" },
      { name: "description", content: "Commercial projects by Ph. G studio." },
    ],
  }),
...
function Commercial() {
  const items = projectsByCategory.commercial;
  return (
      ...
      <section className="mx-auto grid max-w-[1400px] grid-cols-1 gap-x-8 gap-y-14 px-6 pt-32 pb-24 md:grid-cols-2 md:px-10">
        {items.map((p) => (
          <Link
            ...
            params={{ category: "commercial", slug: p.slug }}
