...
export const Route = createFileRoute("/projects/residential")({
  head: () => ({
    meta: [
      { title: "Residential Ph. G studio" },
      { name: "description", content: "Residential projects by Ph. G studio." },
    ],
  }),
...
function Residential() {
  const items = projectsByCategory.residential;
  return (
      ...
      <section className="mx-auto grid max-w-[1400px] grid-cols-1 gap-x-8 gap-y-14 px-6 pt-32 pb-24 md:grid-cols-2 md:px-10">
        {items.map((p) => (
          <Link
            ...
            params={{ category: "residential", slug: p.slug }}
